package digital.tonima.bibliadigital.feature.bible.impl.tts
...
import digital.tonima.bibliadigital.feature.bible.impl.tts.TTSEvent.NextChapter
import digital.tonima.bibliadigital.feature.bible.impl.tts.TTSEvent.PreviousChapter
...
class TTSService : MediaSessionService(), TextToSpeech.OnInitListener {
    ...
    private fun updateNotification() {
        ...
        val pendingIntent = PendingIntent.getActivity(this, 0, launchIntent, FLAG_IMMUTABLE)
